...
import librarymanagement.employeemanagementsystem_10.dto.EmployeeNameAndEmailDto;
import librarymanagement.employeemanagementsystem_10.entity.Employee;
import librarymanagement.employeemanagementsystem_10.projection.EmployeeNameAndEmailProjection;
...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("""
            SELECT new librarymanagement.employeemanagementsystem_10.dto.EmployeeNameAndEmailDto(e.name, e.email) \
